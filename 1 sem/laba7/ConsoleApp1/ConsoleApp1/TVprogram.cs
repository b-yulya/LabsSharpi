...
namespace ConsoleApp1
{
    ...
    class Film : TVprogram, ITVprogram
    {
        ...
        public Film(int ch)
        {
            if(ch <= 0)
            {
                throw new YearException("Задайте правильное значение");   // Проверка
    ...
    class News : TVprogram, ITVprogram
    {
        ...
        public News(int age)
        {
            if(age<0 || age > 120)
            {
                throw new AgeLimitException("Введите правильный возраст"); // Проверка
            }
            agelimit = age;
            count++;
        }
    ...
    struct User
    {
        ...
        public void Info()
        {
            ...
            {
                throw new NullStringException("Имя не задано");  // Проверка
            }
            if (Age <0 || Age > 120)
            {
                throw new YearException("Укажите правильный возраст");  // Проверка
            }
